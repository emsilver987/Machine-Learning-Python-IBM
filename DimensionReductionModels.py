...
# Four distinct clusters, some wrong cluster profiling, clusters similar densities
...
# 4 distict clusters, some wrong clustering, clusters similar density, more 'connected-ness' then t-SNE
...
# releative blob densities, same separation, distance between clusters is very similar