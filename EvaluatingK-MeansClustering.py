...
# They vary with different inital centriod seeds. Inertia values are somewhat inconsistent, thus indicating the clustering process is senstive
# to inital placement of centriods
...
# Inertia decreases as the number of clusters increases. Inertera plot points to optimal cluster num around 3 or 4. Sihoutte score shows peak at k=3. Overall, looks like 3 clusters is best.
...
# Could still argue that 3 is optimal. k=4 are split into more distinct clusters.
# Vissually we see that k=4 may be better which introduces some subjectivity
...
# K-means did a good job at identifying clusters that agree with the labled data
# Silhoutte score is higher for cluster result than for actual calss labels
